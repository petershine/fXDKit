		  ...
		  addOperationWithBlock:^{
			  ...
			  if (didEnumerateBlock) {
				  ...
				  [[NSNotificationCenter defaultCenter]
				   postNotificationName:notificationCloudManagerDidEnumerateUbiquitousMetadataItems
				   object:self
				   userInfo:userInfo];
			  }
		  }];
		 ...
		 [[NSOperationQueue mainQueue]
		  addOperationWithBlock:^{
			  ...
			  if (didEnumerateBlock) {
				  ...
				  [[NSNotificationCenter defaultCenter]
				   postNotificationName:notificationCloudManagerDidEnumerateUbiquitousDocuments
				   object:self
				   userInfo:userInfo];
			  }
		  }];
